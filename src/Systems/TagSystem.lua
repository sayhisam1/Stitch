...
function TagSystem:onCreate(stitch)
	...
	local function registerComponent(component)
		...
		local signal = CollectionService:GetInstanceAddedSignal(component.name)
		self._instanceAddedListeners[component.name] = signal:connect(function(instance: Instance)
